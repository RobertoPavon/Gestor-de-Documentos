...
<body>
    ...
    <div class="ingreso">
        <h1 class="ventah1">Editar Días Laborales del Mes</h1><br><br>
            <div class="formulario">
                <form action="dias_laborales.php" method="POST"> 
                    ...
                    <!-- <h4 class="validacion">Validacion Incorrecta</h4> -->
                            ...
                            <select name="mes" id="">
                                ...
                                if(isset($_POST['mes'])){                                        
                                    if(empty($mes)){
                                        ...
                                        $result=$sql->fetch();
                                        if($result==false){
                                            echo('<h4 class="validacion">Primero Debes Registrar una cantidad de Días Laborales para este Mes</h4>');
                                            $error = 1;
                                        }
                                    }
                                }
                            ...
                            <div>                                 
                                ...
                                if(isset($_POST['dias'])){
                                    if(empty($dias)){
                                        ...
                                        try {
                                            $sql=$conn->prepare('Update dvm set dias = ? where sucursal = ? and mes = ? and año = ?) values (?,?,?,?)');
                                            $result=$sql->execute([$dias, $numero, $mes, $año]);                                 
                                            if($result==true){?>
