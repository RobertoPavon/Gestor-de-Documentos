...
if($tipo != '3'){
    ...
    INNER JOIN sucursales on recibos.sucursal = sucursales.numero where 
    (recibos.sucursal like '%$busqueda%' or
    sucursales.nombre like '%$busqueda%' or
    recibos.autorizacion like '%$busqueda%' or
    recibos.fechaDeposito like '%$busqueda%' or
    recibos.fechaCarga like '%$busqueda%' or
    recibos.documento like '%$busqueda%')");                    
    $result=$sql->fetchAll();
}elseif($tipo === '3'){  
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td class="celda_grande"">Sucursal</td>
